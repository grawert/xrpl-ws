...
impl DepositPreauthBuilder {
    ...
    pub fn with_authorize(mut self, authorize: impl Into<String>) -> Self {
        self.transaction_type.authorize = Some(authorize.into());
        self
    }

    /// Revokes deposit authorization from the specified account.
    pub fn with_unauthorize(mut self, unauthorize: impl Into<String>) -> Self {
        self.transaction_type.unauthorize = Some(unauthorize.into());
        self
    }
}
