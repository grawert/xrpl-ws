...
async fn test_mpt_rwa_authorized_issuance() {
    let issuer_wallet = sender_wallet();
    let issuer_addr = sender_address();
    ...
    let submit = SubmitRequestBuilder::new(&create_tx, &issuer_wallet)
        .build()
    ...
    let submit = SubmitRequestBuilder::new(&opt_in_tx, &holder_wallet)
        .build()
        .expect("Failed to build submit request");
    ...
    let submit = SubmitRequestBuilder::new(&authorize_tx, &issuer_wallet)
        .build()
        .expect("Failed to build submit request");
    ...
    let submit = SubmitRequestBuilder::new(&send_tx, &issuer_wallet)
        .build()
        .expect("Failed to build submit request");
    ...
    let submit = SubmitRequestBuilder::new(&return_tx, &holder_wallet)
        .build()
        .expect("Failed to build submit request");
    ...
    let submit = SubmitRequestBuilder::new(&opt_out_tx, &holder_wallet)
        .build()
        .expect("Failed to build submit request");
    ...
    let submit = SubmitRequestBuilder::new(&destroy_tx, &issuer_wallet)
        .build()
        .expect("Failed to build submit request");
...
async fn test_mpt_stablecoin_usdx_issuance() {
    ...
    let submit = SubmitRequestBuilder::new(&clawback_tx, &issuer_wallet)
        .build()
        .expect("Failed to build submit request");
