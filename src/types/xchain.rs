...
impl From<&XChainBridge> for XChainBridge {
    fn from(b: &XChainBridge) -> Self {
        b.clone()
    }
}
...
impl XChainBridge {
    ...
    pub fn new(
        locking_chain_door: impl AsRef<str>,
        locking_chain_issue: impl Into<Asset>,
        issuing_chain_door: impl AsRef<str>,
        issuing_chain_issue: impl Into<Asset>,
    ) -> Self {
        Self {
            locking_chain_door: locking_chain_door.as_ref().to_string(),
            locking_chain_issue: locking_chain_issue.into(),
            issuing_chain_door: issuing_chain_door.as_ref().to_string(),
