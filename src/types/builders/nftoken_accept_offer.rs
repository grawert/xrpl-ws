...
impl NFTokenAcceptOfferBuilder {
    ...
    pub fn with_nftoken_sell_offer(mut self, offer: impl Into<String>) -> Self {
        self.transaction_type.nftoken_sell_offer = Some(offer.into());
        self
    }

    /// Sets the ledger object ID of the buy offer to accept.
    pub fn with_nftoken_buy_offer(mut self, offer: impl Into<String>) -> Self {
        self.transaction_type.nftoken_buy_offer = Some(offer.into());
        self
    }
