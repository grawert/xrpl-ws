...
impl NFTokenMintBuilder {
    ...
    pub fn new(account: impl Into<String>, nftoken_taxon: u32) -> Self {
        Self::init(
            account,
            0,
            Amount::default(),
    ...
    pub fn with_issuer(mut self, issuer: impl Into<String>) -> Self {
        self.transaction_type.issuer = Some(issuer.into());
        self
    }
...
mod tests {
    ...
    fn test_nftoken_mint_invalid_account() {
        let result =
            NFTokenMintBuilder::new("not_an_address".to_string(), 0).build();
