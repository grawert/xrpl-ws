...
/// Represents an amount of currency on the XRPL, either XRP or an issued currency.
///
/// # Examples
///
...
/// ```rust
/// use xrpl_ws::Amount;
/// let amount = Amount::Xrpl("1.5".to_string());
/// ```
///
/// Create an issued currency amount (100 USD issued by rEXAMPLEissuer):
/// ```rust
/// use xrpl_ws::Amount;
/// let amount = Amount::IssuedCurrency {
///     value: "100".to_string(),
///     currency: "USD".to_string(),
///     issuer: "rEXAMPLEissuer".to_string(),
/// };
/// ```
