...
impl SignerEntry {
    ...
    pub fn new(account: impl Into<String>, signer_weight: u16) -> Self {
        Self { account: account.into(), signer_weight, wallet_locator: None }
    }

    /// Attaches a 256-bit wallet locator.
    pub fn with_wallet_locator(
        mut self,
        wallet_locator: impl Into<String>,
    ) -> Self {
        self.wallet_locator = Some(wallet_locator.into());
        self
    }
}
