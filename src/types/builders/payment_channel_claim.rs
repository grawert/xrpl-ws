...
impl PaymentChannelClaimBuilder {
    ...
    pub fn new(account: impl Into<String>, channel: impl Into<String>) -> Self {
        Self::init(
            account,
            0,
            Amount::default(),
    ...
    pub fn with_credential_ids(
        ...
        self.transaction_type.credential_ids =
            Some(credential_ids.into_iter().map(|s| s.into()).collect());
        self
    }
    ...
    pub fn with_public_key(mut self, public_key: impl Into<String>) -> Self {
        self.transaction_type.public_key = Some(public_key.into());
        self
    }

    /// Sets the sender's signature authorizing the claim amount.
    pub fn with_signature(mut self, signature: impl Into<String>) -> Self {
        self.transaction_type.signature = Some(signature.into());
        self
    }
}
