...
impl AccountObjectsRequest {
    ...
    pub fn with_deletion_blockers_only(mut self, value: bool) -> Self {
        self.deletion_blockers_only = Some(value);
        self
    }
    ...
    pub fn with_kind(mut self, kind: AccountObjectType) -> Self {
        self.kind = Some(kind);
        self
    }
}
