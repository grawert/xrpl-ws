...
impl NFTokenCancelOfferBuilder {
    ...
    pub fn new(
        ...
        nftoken_offers: impl IntoIterator<Item = impl Into<String>>,
    ) -> Self {
        Self::init(
            account,
            0,
    ...
    pub fn add_offer(mut self, offer: impl Into<String>) -> Self {
        self.transaction_type.nftoken_offers.push(offer.into());
        self
    }
}
